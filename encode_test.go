...
func TestMarshal_And_Encoder(t *testing.T) {
	...
	expected := []byte{0x83, 0xA7, 0x66, 0x6C, 0x6F, 0x61, 0x74, 0x36, 0x34, 0xCA, 0x41, 0x18, 0x00, 0x00, 0xA1, 0x2D,
		0xA6, 0x68, 0x79, 0x70, 0x68, 0x65, 0x6E, 0xA8, 0x75, 0x6E, 0x73, 0x69, 0x67, 0x6E, 0x65, 0x64, 0x20}
