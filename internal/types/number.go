...
func (i *Int) ReadFrom(code byte, r io.Reader) (int64, error) {
	// TODO
...
func (u *Uint) ReadFrom(code byte, r io.Reader) (int64, error) {
	// TODO
	return 0, utils.InvalidArgumentError{}
}
...
func (f *Float) ReadFrom(code byte, r io.Reader) (int64, error) {
	// TODO
	return 0, utils.InvalidArgumentError{}
}
